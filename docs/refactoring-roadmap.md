...
This living roadmap tracks behavior-preserving, independently reviewable refactors—not feature work. Baseline: `a7a710f`.
...
Item 3 is an audited queued item and remains blocked; item 4 is completed.
